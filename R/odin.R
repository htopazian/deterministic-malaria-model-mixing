## Automatically generated by odin 1.2.2 - do not edit
odin_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age02", "age05",
             "age10", "age20l", "age20u", "age59", "b0", "b1", "betaL",
...
odin_model_metapop_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("aD", "age", "age_20_factor", "age_rate", "age02", "age05",
             ...
             "init_ICA", "init_ICM", "init_ID", "init_Iv", "init_LL",
             "init_P", "init_PL", "init_S", "init_Sv", "init_T", "init_U",
             "irs_cov", "IRS_interval", "irs_loss", "IRS_on", "itn_cov",
             "ITN_interval", "itn_loss", "ITN_on", "kB", "kC", "kD", "mix",
             "mu0", "muEL", "muLL", "muPL", "mv0", "na", "nh", "np",
             "num_int", "omega", "p10", "p2", "phi0", "phi1", "pi", "PM",
             "Q0", "r_IRS0", "r_ITN0", "r_ITN1", "rA", "rD", "rel_foi", "rP",
             "rT", "rU", "ssa0", "ssa1", "ssa2", "ssa3", "ssb1", "ssb2",
             "ssb3", "tau1", "tau2", "theta_c", "uB", "uCA", "uD", "x_I"),
